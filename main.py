...
# if 1:
  ...
  if 'wikipedia' in query:
    ...
    speak('Right away, sir! The meaning of life is 42.')
  
  elif 'how are you' in query:
    speak('I am doing jolly good, sir.All systems are at 100 percent. Battery percentage: 100%. Battery state: discharging. 265 processes are currently running. Current volume is 30 percent')
  
  elif 'Who is iron man?' in query:
    speak('Iron man is the one who created me sir!.')
